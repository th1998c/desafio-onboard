...
public class Config implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Payment payment1 = new Payment(null,50.00, LocalDate.of(2022, 05, 05));
		Payment payment2 = new Payment(null,120.00, LocalDate.of(2023, 05, 12));
		Payment payment3 = new Payment(null,100.00, LocalDate.of(2022, 11, 15));
